    ...
    <div>
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" rel="noreferrer" href="https://js-mastery-ci.sentry.io/issues/?project=4510858855645264">Issues Page</a>.
